# -*- coding: utf-8 -*-
"""Apply sumTable verdict IIFE without breaking newline."""
from pathlib import Path

p = Path(r"assets/index-eTNXNndF.js")
t = p.read_text(encoding="utf-8")
neu = Path(r"_kw5_snips/_sum_iife_neu.js").read_text(encoding="utf-8").rstrip()
...
t = t[:start] + neu + mark + t[end + len(mark):]
